 ...
 */
public class ModelInterfaceGen
{
	...
	/** Logger */
	private static final CLogger log = CLogger.getCLogger(ModelInterfaceGen.class);
	 ...
	 */
	public ModelInterfaceGen(int AD_Table_ID, String directory, String packageName, String entityTypeFilter) {
...
//				+ " AND c.ColumnName NOT LIKE 'Updated%' "
	...
	public static void generateSource(MModelGenerator mmGen)
	{
		...
		try
		{
			...
			while (rs.next())
			{
				new ModelInterfaceGen(rs.getInt(1), directory.toString(), packageName, columnFilter);
			}
		}
		catch (SQLException e)
		{
